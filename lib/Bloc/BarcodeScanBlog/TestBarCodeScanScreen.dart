...
void main() {
  runApp(TestBarCodeScanScreen());
}

class TestBarCodeScanScreen extends StatefulWidget {
  @override
  _TestBarCodeScanScreenState createState() => _TestBarCodeScanScreenState();
}

class _TestBarCodeScanScreenState extends State<TestBarCodeScanScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: AppBar(
          title: Text('Help me Figure out the seting for the Scanning'),
          actions: <Widget>[
            IconButton(
