...
class AppColors {
  static final Color orange = Color(0xFFfc9f6a);
  static final Color pink = Color(0xFFee528c);
  static final Color blue = Color(0xFF8bccd6);
  static final Color darkBlue = Color(0xFF60a0d7);
  static final Color valueBlue = Color(0xFF5fa0d6);
  ...
  static final Color  BlackLight = Color(0xff22222b);
  ...
  static Color GreenChangeGreen = Color(0xFF8EC985);
  static Color YellowBackground = Color(0xFFF6F5E8);
  static Color YellowLight = Color(0xfffffef2);
  static Color YellowDark = Color(0xfff6f5e8);
  static Color YellowDarker = Color(0xfff6f5e8);
  static const List<Color> MenuAppbackGroundcolors = <Color>[
...
//
  ...
  static Color LightOrange = Color(0xFFFF9F59);
  static Color WhiteLight = Color(0xFFE4E6F1);
...
//  static Color text = const Color(0x1F000000);
  ...
  static get OrangeArror => Color(0xfff5a623);

  static get CityColorList => [
        Colors.white,
  ...
  static get ArrorGrey => Color(0xffd8d8d8);
}
