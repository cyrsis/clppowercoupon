...
//    }
//    return height;
//    // (hansmuller): this should compute the overall line height for the
...
//      final Offset borderOffset = _boxParentData(container).offset;
//      switch (textDirection) {
//        case TextDirection.rtl:
...
//          decoration.borderGap.start = _boxSize(icon).width +
//              borderOffset.dx +
...
//        case TextDirection.rtl:
//          dx =
//              labelOffset.dx - label.size.width * (2); // origin is on the right
//          break;
//        case TextDirection.ltr:
//          dx = borderOffset.dx +
//              container.size.width / 2 -
//              label.size.width / 2; // origin on the left
//          break;
//      }
...
//            'Declaring both prefix and prefixText is not allowed'),
//        assert(!(suffix != null && suffixText != null),
//            'Declaring both suffix and suffixText is not allowed'),
//        isCollapsed = false;
//
