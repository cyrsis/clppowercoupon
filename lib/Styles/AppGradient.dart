...
class AppGradient {
  ...
  static final RadialGradient RadialGradientRadius = new RadialGradient(
      colors: [Colors.red, Colors.cyan, Colors.purple, Colors.lightGreenAccent],
      center: Alignment(-0.7, -0.6),
      radius: 0.2, // 0.5 is the full
      tileMode: TileMode.clamp,
      focal: Alignment(0.0,0.5) ,
      stops: [0.3, 0.5, 0.6, 0.7]);

  static final RadialYelloPink =
      new RadialGradient(colors: [Colors.yellow, Colors.pink]);
  ...
  static get LinearRedOrganeRepeat => LinearGradient(
    begin: Alignment(0.0,-1.0),
    end: Alignment(0.0,-0.8), //-0.8 = from top 0.2
    stops: [0.0, 0.7],//2 Color, how much for the change
    colors: [
      Color(0xFFF12711),
      Color(0xFFf5af19),
    ],
