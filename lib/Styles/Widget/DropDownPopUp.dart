...
class ExampleApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: DropDownItemScreen(),
    );
  }
}

class DropDownItemScreen extends StatefulWidget {
  @override
  _DropDownItemScreenState createState() => _DropDownItemScreenState();
}

class _DropDownItemScreenState extends State<DropDownItemScreen> {
