...
class AppConst {
  static get SportifyTitles =>['Electronic/Dance', 'Pop', 'HiHop', 'Podcasts'];

  static get  TemiCommand=>"TemiCommand";
  static get  TemiSpeech=>"TemiSpeech";

  static get CreatizeApp => "CreatizeApp";

  static get CreatizeColumnWidget => "ColumnWidget";

  static get YooumaSpaUnit => "yooumaspaunit";
  static get YooumaSpa => "yooumaspa";
  static get YooumaMusicAll => "yooumamusic";
  static get YooumaUserRecording => "yooumanuserrecording";
  static get YooumaSpaRecording => "yooumansparecording";
  static get YooumaFavourite => "yooumafavourite";
  static get  DoubleInfinity => 9999999999.0;
  static get  NegativeDoubleInfinity => -9999999999.0;
  ...
  //strings
  static const String appName = "Flutter Rad";
