...
//For Shape Propertes
class   AppShape {
  static get BeveledRectangleWBorder =>BeveledRectangleBorder(
  side: BorderSide(width: 1, color: Colors.red),
  borderRadius: BorderRadius.circular(10));


  static get CircleBorderRadius => CircleBorder();
  ...
  static get RoundBorderRadius50 => RoundedRectangleBorder(
      borderRadius: BorderRadius.all(Radius.circular(50.0)));

  static get RoundBorderRadius30 => RoundedRectangleBorder(
      borderRadius: BorderRadius.all(Radius.circular(30.0)));




  static get RoundBorderRadius80 => RoundedRectangleBorder(
