...
class AppStyle {
  ...
  static final TextStyle Montserrat16W400 = TextStyle(
      fontSize: 16, fontFamily: "Montserrat", fontWeight: FontWeight.w400);

  static final TextStyle Montserrat40W700 = TextStyle(
  ...
  static final TextStyle Futura14Black = new TextStyle(
    fontSize: 14,
    fontWeight: FontWeight.w400,
    fontFamily: "Futura",
    color: Color(0xFF000000),
  );
  static final TextStyle Futura18Black = TextStyle(
    fontSize: 18,
    fontWeight: FontWeight.w400,
    fontFamily: "Futura",
    color: Color(0xFF000000),
  ...
  static final TextStyle Futura12Grey = TextStyle(
    fontSize: 12,
    fontWeight: FontWeight.w400,
    fontFamily: "Futura",
  ...
  static final TextStyle Futura10 = TextStyle(
    fontSize: 10,
    fontWeight: FontWeight.w400,
    fontFamily: "Futura",
    letterSpacing: 0.48,
  );
  static final TextStyle FuturaCondensed24Black = TextStyle(
    fontSize: 24,
    fontWeight: FontWeight.w400,
  ...
  static final TextStyle Raleway29White = TextStyle(
    fontSize: 29.43,
    fontWeight: FontWeight.w400,
    fontFamily: "Raleway",
  ...
  static final TextStyle RaleWay11Black = TextStyle(
    fontSize: 12,
  ...
  static final TextStyle RaleWay12White = TextStyle(
    fontSize: 12,
    fontWeight: FontWeight.bold,
    fontFamily: "Raleway",
    letterSpacing: 1.6,
  ...
  static final TextStyle f18Bold = TextStyle(
    fontWeight: FontWeight.bold,
    fontSize: 18.0,
  );
  static final TextStyle f16Grey = TextStyle(
    fontWeight: FontWeight.normal,
    fontSize: 16.0,
    color: Colors.grey,
  );
  final TextStyle f18BoldWhite = TextStyle(
      fontWeight: FontWeight.bold, fontSize: 18.0, color: Colors.white);

  static final TextStyle f16White = TextStyle(
    fontWeight: FontWeight.normal,
    fontSize: 16.0,
    color: Colors.white,
  );
  static final TextStyle f20LOrange = TextStyle(
    fontWeight: FontWeight.bold,
    fontSize: 20.0,
    color: AppColors.LightOrange,
  );
  static final TextStyle f20Black = TextStyle(
    fontSize: 20.0,
    color: Colors.black,
    fontWeight: FontWeight.bold,
  );
  static final TextStyle f20Grey = TextStyle(
    fontSize: 20.0,
    color: Colors.grey,
    fontWeight: FontWeight.bold,
  );
  static final TextStyle f30Black = TextStyle(
    fontSize: 30.0,
    color: Colors.black,
    fontWeight: FontWeight.bold,
  );
  static final TextStyle f22BlueGrey = TextStyle(
    fontSize: 22.0,
    color: Colors.blueGrey,
    fontWeight: FontWeight.bold,
  );
  static final TextStyle f30WhiteBold = TextStyle(
    fontSize: 30.0,
    color: Colors.white,
    fontWeight: FontWeight.bold,
  );
  ...
  static get Avenir12Red => new TextStyle(
        color: Colors.red,
        fontFamily: 'Avenir',
        fontSize: 12.0,
      );
  ...
  static Avenir24DarkColor(Color color) {
  ...
  static get Avenir24DarkGreenChange => new TextStyle(
        color: AppColors.BlackHeadLine,
        fontWeight: FontWeight.w400,
        fontFamily: 'Avenir',
        letterSpacing: 0.54,
  ...
  static get RaleWay19White => TextStyle(
        fontSize: 19.64,
        fontWeight: FontWeight.w400,
        fontFamily: "Raleway",
        color: Color(0xFFFFFFFF),
  ...
  static get SFPro14 => new TextStyle(
        fontSize: 14,
        fontWeight: FontWeight.w400,
  ...
  static MonstserratSemiBold10(context) => TextStyle(
  ...
  static get MontserratBold20White => TextStyle(
      color: Colors.white, fontSize: 20.0, fontFamily: "Montserrat-Bold");
  ...
  static get Billabong60Black => new TextStyle(
  ...
  static Google(color, fontSize, height) {
    return new TextStyle(
      color: color,
      fontSize: fontSize,
      height: height,
